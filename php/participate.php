...
foreach ($guest_list as $guest){
    ...
    $insert_party_guest = "insert into guest_party values($guest,$party_num);";
    if(!mysqli_query($link,$insert_party_guest)){
        echo "Can't insert participation information. Error:".mysqli_error($link);
        exit(1);
    }else{
        echo "Success!\n";
    }
